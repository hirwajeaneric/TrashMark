...
const StatsCard = ({stat, reportPeriod}) => {
    return (
        <Link to={stat.address || ''} className={`flex flex-col items-start gap-2 justify-center w-full ${stat.size === '[24%]' && 'sm:w-[48%]'} md:w-${stat.size} p-6 rounded-lg border border-gray-300`} >
